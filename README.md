...
|8|8 декабря 2021|разбор практических задач + частотный анализ текстов и TF-IDF|
|9|15 декабря 2021|библиотеки для морфоанализа: pymorphy, mystem и др|
|10|22 декабря 2021|собираем корпус: парсеры,краулеры,скрепперы|
|11|29 декабря 2021|синтаксические анализаторы|
|12||pandas, работа с датасетами|
|13||визуализация данных в Питоне|
|14|||
